...
{
	return {
		"name":			"Sine Extended",			// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"SinX",			// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",
		"description":	"Standard Scirra Sine improved with RESET function.",
		"author":		"Scirra",
...
var property_list = [
	...
	new cr.Property(ept_combo,		"Movement",				"Horizontal", "Select what property of the object to modify.", "Horizontal|Vertical|Size|Width|Height|Angle|Opacity|Value only"),
